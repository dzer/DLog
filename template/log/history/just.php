                        ...
                        <tr class="<?= $is_danger ? 'danger' : '' ?>">
                            ...
                            <td>
                                <div>
                                    ...
                                    <a class="line" target="_blank" style="<?= $log['content']['traceId'] == 0 ? 'font-weight:bold' : ''?>" href="/log/History/trace?request_id=<?= $log['requestId'] ?>&time=<?= urlencode($log['time'])?>"><?= $log['content']['url'] ?></a>
                                </div>
